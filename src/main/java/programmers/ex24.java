...
public class ex24 {
    ...
    public static int[] solution(String today, String[] terms, String[] privacies) throws Exception {
        ...
        for (String privacy : privacies) {
            ...
            Date curDate = df.parse(temp[0]);
            cal.setTime(curDate);
            cal.add(Calendar.MONTH, termsMap.get(temp[1].charAt(0)));
