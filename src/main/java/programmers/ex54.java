...
public class ex54 {
    ...
    public static int solution(String str1, String str2) {
        ...
        for (int i = 1; i < str1.length(); i++) {
            if (!Character.isAlphabetic(str1.charAt(i - 1)) || !Character.isAlphabetic(str1.charAt(i))) continue;
            String s = Character.toString(str1.charAt(i - 1))  + Character.toString(str1.charAt(i));
            a.add(s.toLowerCase());
        }

        for (int i = 1; i < str2.length(); i++) {
            if (!Character.isAlphabetic(str2.charAt(i - 1)) || !Character.isAlphabetic(str2.charAt(i))) continue;
            String s = Character.toString(str2.charAt(i - 1))  + Character.toString(str2.charAt(i));
            b.add(s.toLowerCase());
        }
        ...
        double totalCnt = b.size();
        double temp = dubCnt / totalCnt * 65536;
